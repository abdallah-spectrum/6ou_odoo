...
class LeaveBalanceReport(models.Model):
    ...
    month=fields.Datetime(' month ', readonly=True, copy=False)
        ...
        for employee_id in employee_ids:
            ...
            for leave in leave_ids:
                if leave.holiday_status_id.id not in balances_dict:
                    balances_dict[leave.holiday_status_id.id] = {'allocated': 0.0, 'taken': leave.number_of_days,'month':leave.date_from}
                else:
